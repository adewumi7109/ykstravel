...
function Services() {
    ...
    return (
        <div className="services  p-4 md:p-10 mt-[3rem]">
            <h1 className="md:text-4xl text-3xl text-center text-primary">Our services</h1>
            ...
            <div className="grid mt-[3rem] grid-cols-1 sm:grid-cols-2  md:grid-cols-3 lg:grid-cols-2 gap-8">
                <div className="bg-primary  rounded p-4 shadow-xl text-white " data-aos="fade-right">
